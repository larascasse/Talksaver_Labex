(function( Popcorn ) {
  ...
  Popcorn.playerLive = function( name, player ) {
    ...
    var playerFn = function( target, src, options ) {
      ...
      for( var val in container ) {
        ...
        if ( typeof container[ val ] === "object" ) {
          ...
          Popcorn.playerLive.defineProperty( basePlayer, val, {
            get: (function( value ) {
      ...
      Popcorn.playerLive.defineProperty( basePlayer, "currentTime", {
        get: function() {
      ...
      Popcorn.playerLive.defineProperty( basePlayer, "volume", {
        get: function() {
      ...
      Popcorn.playerLive.defineProperty( basePlayer, "muted", {
        get: function() {
      ...
      Popcorn.playerLive.defineProperty( basePlayer, "readyState", {
        get: function() {
      ...
      if ( playerLive._teardown ) {

        popcorn.destroy = combineFn( popcorn.destroy, function() {
        
        	playerLive._teardown.call( basePlayer, options );
        });
      }
    ...
    playerFn.canPlayType = playerLive._canPlayType = playerLive._canPlayType || Popcorn.nop;

    Popcorn[ name ] = Popcorn.playerLive.registry[ name ] = playerFn;
  };

  Popcorn.playerLive.registry = {};

  Popcorn.playerLive.defineProperty = Object.defineProperty || function( object, description, options ) {
  ...
  Popcorn.smart = function( target, src, options ) {
    ...
    for ( var key in Popcorn.playerLive.registry ) {

      if ( Popcorn.playerLive.registry.hasOwnProperty( key ) ) {

        if ( Popcorn.playerLive.registry[ key ].canPlayType( node.nodeName, src ) ) {
